...
def create_app(test_config=None):
    app = Flask(__name__)
    app.config['SQLALCHEMY_DATABASE_URI'] = 'postgres://bqqzxowekpqbts:2f7eed4c9e0d6ceec5beb4b14957ebc492f9100ca03d9413b0c7f0157f7759a2@ec2-34-236-94-53.compute-1.amazonaws.com:5432/d1blmlajr1s732'
